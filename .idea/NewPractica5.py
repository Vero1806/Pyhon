...
'''
Ejercicio09
Vamos a crear un registro de eventos con un diccionario donde se registre el código del evento y 
después la fecha y hora, el tipo de evento (que solo acepte los valores normal o crítico), y el nombre). 
